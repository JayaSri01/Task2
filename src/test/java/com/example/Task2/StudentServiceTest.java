...
@ExtendWith(MockitoExtension.class)
    public class StudentServiceTest {
        ...
        public void testGetDetails() {
            ...
            list.add(new Student(1,"venkatesh",24,10000));
            list.add(new Student(2,"pavan",24,10000));
            list.add(new Student(3,"srujan",24,10000));
            list.add(new Student(4,"sahith",24,10000));
        ...
        public void testAddStudent() {
            Student s=new Student(1,"venkatesh",25,100000);
        ...
        public void testUpdate() {
            Student s=new Student(1,"venkatesh",25,100000);
            Student s1=new Student(2,"sathish",26,1000000);
            when(sRepo.findById(1)).thenReturn(Optional.of(s));
            when(sRepo.save(s)).thenReturn(s);
        ...
        public void testDelete() {
            Student s=new Student(2,"venkatesh",25,100000);
